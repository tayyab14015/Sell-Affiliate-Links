...
import { SITE_EMAIL, SITE_NAME, SITE_URL, absoluteUrl } from '../site';
    ...
    <>
      ...
      <article className="container section about-page">
        ...
        <p>
          ...
          Product explainers such as the Blackzero kit pages are edited by <strong>Daniel Kessler</strong>.
          Spec tables are checked against manufacturer documentation; if a street listing disagrees
          with the vendor sheet, we trust the vendor sheet and tell you to match the part number.
        </p>

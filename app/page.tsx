        ...
        <div className="container hero-inner">
          <div className="hero-copy">
            ...
            <p className="hero-sub">
              ...
              you straight to the current deal. We also curate USB hubs, not only laptops. No
              noise, no clickbait, just real specs and honest recommendations.
            </p>
            <div className="hero-cta">
              <Link href="/laptops" className="btn btn-primary">
                Shop all laptops →
              </Link>
              <Link href="/usb-hubs" className="btn btn-ghost">
                Browse USB hubs
              </Link>
            </div>
        ...
        <div className="container about-inner">
          <div className="about-copy">
            ...
            <p>
              ...
              Chromebooks, and mobile workstations — plus USB hubs and accessories for the same
              audience. New picks are added as they become worth recommending.
            </p>
            <div className="hero-cta">
